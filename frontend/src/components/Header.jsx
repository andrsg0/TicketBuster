      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link to="/" className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" className="w-12 h-12 fill-gray">
            ...
            <span className="ml-2 text-xl font-bold text-gray hidden sm:inline">TicketBuster</span>
          </Link>
        </div>

        {/* Navigation Links */}
        <nav className="hidden md:flex items-center gap-6">
          <Link to="/" className="text-gray hover:text-primary transition-colors font-medium">
            Inicio
          </Link>
          <Link to="/events" className="text-gray hover:text-primary transition-colors font-medium">
            Eventos
          </Link>
          {user && (
            <Link to="/my-tickets" className="text-gray hover:text-primary transition-colors font-medium">
              Mis Tickets
            </Link>
          )}
        </nav>
          ...
          {user ? (
            <div className="flex items-center gap-3">
              <div className="hidden sm:block text-right">
                <p className="text-sm font-medium text-gray">{user.name || user.email}</p>
